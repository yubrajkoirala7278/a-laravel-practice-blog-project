...
@section('content')
    <div class="p-4 bg-white">
        <h3 class="fw-semibold fs-4 text-success">Edit Blogs</h3>
        <form method="POST" action="{{ route('admin.blogs.update', $blog->slug) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" name="title"
                    value="{{ old('title', $blog->title) }}" oninput="generateSlug()">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description-content" placeholder="Enter the Description" rows="5"  name="description">{{old('description',$blog->description)}}</textarea>
                @error('description')
                    <div class="error text-sm text-danger">{{ $message }}</div>
                @enderror
            </div>
                ...
                <div class="d-flex align-items-center" style="gap: 10px">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="1" name="is_published" id="publish"
                            @if (old('is_published', $blog->is_published) == 1) checked @endif>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="0" name="is_published" id="unpublish"
                            @if (old('is_published', $blog->is_published) == 0) checked @endif>
